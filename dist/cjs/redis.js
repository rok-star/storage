...
exports.createRedisDriver = exports.RedisStorageDriverOptionsSchema = void 0;
const libschema = require("schema");
const libredis = require("redis");
exports.RedisStorageDriverOptionsSchema = {
    type: 'object',
    props: {
        host: { type: 'string' },
...
const createRedisDriver = (options) => {
    libschema.assert(options, exports.RedisStorageDriverOptionsSchema);
...
exports.createRedisDriver = createRedisDriver;
